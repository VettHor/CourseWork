    ...
    public partial class UserControlGroupedRoad : UserControl
    {
        ...
        private void FindGroupedSeparatedRoadsMoreTwoLanes_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (GroupedHighwayLists[RoadType.state].GetCurrentLength == 0 &&
                ...
                GroupedHighwayLists[RoadType.local].GetCurrentLength == 0) // if length of value of each key is zero
            {
                MessageBox.Show(
            ...
            {
                if (GroupedHighwayLists[i].GetCurrentLength == 0) continue; // if current value of key is empty than continue
